...
const fr: Translations = {
    ...
    api: {
        ...
        clawOwnerUpdated: 'Propriétaire du Claw mis à jour.',
        clawOwnerUnchanged: 'Propriétaire du Claw inchangé.',
        failedToReassignClaw: 'Échec de la réaffectation du Claw !',
