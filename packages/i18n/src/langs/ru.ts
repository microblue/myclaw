...
const ru: Translations = {
    ...
    api: {
        ...
        clawOwnerUpdated: 'Владелец Claw обновлён.',
        clawOwnerUnchanged: 'Владелец Claw не изменён.',
        failedToReassignClaw: 'Не удалось переназначить Claw!',
...
clawName: 'Имя',
    ...
    privacy: {
        ...
        authText:
            'MyClaw.One использует Supabase Authentication для управления учётными записями. Вы можете войти через email, Google или GitHub. Используя эти способы входа, вы соглашаетесь с соответствующими условиями и политиками конфиденциальности. Эти провайдеры могут собирать базовые данные, такие как адрес электронной почты, имя и информацию об устройстве. Мы храним только ваш адрес электронной почты и отображаемое имя.',
        ...
        cookiesText:
            'Мы не используем файлы cookie. Аутентификация осуществляется через Supabase и не зависит от файлов cookie, хранящихся в вашем браузере.',
    ...
    terms: {
        ...
        authText:
            'MyClaw.One использует Supabase Authentication для управления входом. Вы можете аутентифицироваться через email, Google или GitHub. Используя эти методы, вы соглашаетесь с соответствующими условиями и политиками конфиденциальности Google и GitHub. Эти провайдеры могут собирать базовую информацию, такую как адрес электронной почты, имя и данные устройства.',
