...
const ru: Translations = {
    ...
    footer: {
        ...
        productDescription:
            'Разворачивайте агентов OpenClaw в облаке или локально в один клик — создавайте, подключайте и масштабируйте ваших ИИ-агентов быстрее с MyClaw.',
    ...
    emails: {
        otpSubject: 'Ваш код для входа в MyClaw',
        otpPreview: 'Ваш код для входа в MyClaw: {{code}}',
        otpHeading: 'Ваш код для входа:',
        otpExpiry:
            'Срок действия кода истекает через 10 минут. Если это были не вы, проигнорируйте это письмо.',
        featureFooter:
            'Вы получили это письмо, потому что у вас есть аккаунт MyClaw.',
        features: {
            terminal: {
                ...
                description:
                    'Получите доступ к серверу прямо из браузера с помощью встроенного терминала. Не нужен SSH-клиент — просто откройте MyClaw и начните вводить команды.',
            ...
            logs: {
                ...
                description:
                    'Отслеживайте логи сервера в реальном времени из панели MyClaw. Диагностируйте проблемы, отслеживайте развёртывания и отлаживайте приложения, не покидая браузер.',
            ...
            channels: {
                ...
                description:
                    'Подключите ваших ИИ-агентов к Discord, Slack, WhatsApp и другим платформам. Настраивайте каналы и привязывайте их к агентам — всё из панели MyClaw.',
            ...
            fileExplorer: {
                ...
                description:
                    'Просматривайте, читайте и редактируйте файлы на сервере прямо из панели MyClaw. Подсветка синтаксиса, поиск и мгновенное сохранение — без SSH.',
            ...
            agentChat: {
                ...
                description:
                    'Общайтесь с ИИ-агентами прямо из панели MyClaw. Отправляйте сообщения, прикрепляйте изображения и просматривайте историю — всё в одном месте.',
                cta: 'Начать общение'
            },
            voiceMode: {
            ...
            envVars: {
                ...
                description:
                    'Добавляйте, редактируйте и удаляйте переменные окружения прямо из панели MyClaw. Устанавливайте API-ключи, секреты и конфигурацию — без терминала.',
            ...
            sshKeys: {
                subject: 'Знаете ли вы? Управляйте SSH-ключами из MyClaw',
                preview: 'Генерируйте и управляйте парами SSH-ключей в панели',
                tag: 'SSH-ключи',
                heading: 'SSH-ключи — просто',
                description:
                    'Генерируйте пары SSH-ключей, копируйте открытые ключи и скачивайте закрытые — всё из панели MyClaw. Назначайте ключи клоу для безопасного доступа.',
            ...
            multiLanguage: {
                subject: 'Знаете ли вы? MyClaw говорит на вашем языке',
                preview: 'Используйте MyClaw на 14 языках',
                tag: 'Мультиязычность',
                heading: 'MyClaw на вашем языке',
                description:
                    'Переключите всю панель MyClaw на любой из 14 языков. Всё — от кнопок до сообщений об ошибках — полностью переведено.',
                cta: 'Сменить язык'
            },
            subdomain: {
            ...
            darkMode: {
                subject: 'Знаете ли вы? В MyClaw есть тёмная тема',
                preview: 'Переключайтесь между светлой и тёмной темами',
                tag: 'Тёмный режим',
                heading: 'Комфорт для глаз',
                description:
                    'Переключайтесь между светлой и тёмной темами в панели MyClaw. Ваши предпочтения сохраняются и применяются автоматически при каждом посещении.',
    ...
    auth: {
        signIn: 'Войти',
        signInDescription:
            'Войдите в аккаунт MyClaw для управления экземплярами OpenClaw.',
        signingIn: 'Вход...',
    ...
    account: {
        title: 'Аккаунт',
        description:
            'Управляйте настройками аккаунта MyClaw и информацией профиля.',
...
clawName: 'Имя',
    ...
    landing: {
        ...
        tutorialVideoThumbnail: 'Миниатюра обучающего видео MyClaw',
        ...
        openclawControlDescription:
            'Доступ к нативной панели OpenClaw прямо из MyClaw. Полный доступ к редактированию всего, что предлагает OpenClaw.',
        clawHostControl: 'Управление MyClaw',
        ...
        faq1Question: 'Что такое MyClaw?',
        faq1Answer:
            'MyClaw — это платформа, созданная для того, чтобы сделать OpenClaw доступным для всех. Она позволяет как нетехническим пользователям, так и разработчикам запускать OpenClaw без управления инфраструктурой. Мы берём на себя серверы, аптайм, безопасность и обслуживание — вы просто пользуетесь OpenClaw.',
        ...
        faq3Answer:
            'В отличие от размещённых ИИ-инструментов, MyClaw даёт вам реальный сервер с установленным OpenClaw. Вы владеете инфраструктурой, контролируете всё и не ограничены общей платформой или моделью.',
    ...
    changelog: {
        ...
        description:
            'Отслеживайте обновления, новые функции и улучшения MyClaw.',
        subtitle: 'Все обновления, новые функции и улучшения MyClaw.',
        ...
        upcomingReleaseFeature9:
            'Голосовой режим для взаимодействия с агентами OpenClaw на MyClaw (бета)',
        ...
        upcomingReleaseFeature11:
            'Лендинг для MyClaw Go, локальный хостинг с MyClaw',
        ...
        release12Feature3:
            'Голосовой режим для взаимодействия с агентами OpenClaw на MyClaw',
        release12Feature4:
            'Переустановка OpenClaw на экземпляре для чистого старта, доступна раз в день',
        ...
        release1Description:
            'Первый официальный релиз MyClaw. Разверните OpenClaw на собственном VPS в один клик.',
        ...
        release2Description:
            'Новый способ быть в курсе всего, что касается MyClaw.',
        release2Feature1:
    ...
    playground: {
        ...
        loadingTip3:
            'MyClaw — первый в мире проект, позволяющий хостить OpenClaw в один клик.',
        tabChat: 'Чат',
    ...
    privacy: {
        ...
        eligibilityText:
            'Наш Сервис доступен для всех. Ограничений по возрасту для использования MyClaw нет.',
    ...
    terms: {
        ...
        description:
            'Ознакомьтесь с условиями использования сервисов MyClaw.',
        lastUpdated: 'Последнее обновление: 14 марта 2026',
        acceptanceTitle: '1. Принятие условий',
        acceptanceText:
            'Получая доступ и используя MyClaw («Сервис»), вы принимаете и соглашаетесь соблюдать условия и положения данного соглашения. Если вы не согласны с этими условиями, пожалуйста, не используйте наш Сервис.',
        serviceTitle: '2. Описание Сервиса',
        serviceText:
            'MyClaw предоставляет развёртывание OpenClaw в один клик на выделенных серверах. Мы позволяем пользователям разворачивать, управлять и получать доступ к предварительно настроенным экземплярам OpenClaw с полным root-доступом и выделенными ресурсами.',
        ...
        liabilityText:
            'В максимальной степени, допускаемой законом, MyClaw не несёт ответственности за любой косвенный, случайный, особый, последующий или штрафной ущерб, а также за потерю прибыли или доходов, понесённых прямо или косвенно.',
    ...
    compare: {
        ...
        description:
            'Посмотрите, как MyClaw сравнивается с другими платформами хостинга OpenClaw.',
        badge: 'Сравнение',
        feature: 'Платформа',
    ...
    affiliateProgram: {
        ...
        description:
            'Узнайте, как работает партнёрская программа MyClaw, сколько вы можете заработать и правила участия.',
        lastUpdated: 'Последнее обновление: 1 апреля 2026 г.',
        overviewTitle: '1. Обзор',
        overviewText:
            'Партнёрская программа MyClaw позволяет вам зарабатывать вознаграждения, приглашая новых пользователей в MyClaw. Когда кто-то совершает покупку после посещения MyClaw по вашей реферальной ссылке, вы получаете комиссию с его платежей. Программа бесплатна и доступна всем зарегистрированным пользователям MyClaw.',
        howItWorksTitle: '2. Как это работает',
        howItWorksText: 'Начать работу с партнёрской программой просто:',
        howItWorksStep1:
            'Зарегистрируйте аккаунт MyClaw. Уникальный реферальный код генерируется для вас автоматически.',
        howItWorksStep2:
        ...
        howItWorksStep3:
            'Когда кто-то совершает покупку после посещения MyClaw по вашей ссылке, это регистрируется как ваш реферал.',
        howItWorksStep4:
        ...
        rulesNoMisrepresentation:
            'Вы не можете искажать информацию о MyClaw, его услугах или партнёрской программе каким-либо образом.',
        rulesNoIncentivized:
        ...
        terminationText:
            'Любое нарушение этих правил приведёт к немедленной потере всех ожидающих и заработанных вознаграждений. MyClaw оставляет за собой право приостановить или навсегда заблокировать ваш аккаунт в партнёрской программе. В серьёзных случаях ваш аккаунт MyClaw также может быть закрыт. Все решения относительно нарушений являются окончательными.',
        ...
        marketingSocial:
            'Делитесь ссылкой в социальных сетях, таких как X, LinkedIn, Reddit и Facebook. Напишите о своём опыте с MyClaw и включите реферальную ссылку.',
        marketingBlog:
            'Пишите статьи в блоге, руководства или обзоры о MyClaw. Естественно включайте реферальную ссылку в контент.',
        marketingVideo:
            'Создавайте видеоконтент на YouTube или TikTok, демонстрируя, как вы используете MyClaw для развёртывания и управления ИИ-агентами.',
        marketingCommunity:
            'Участвуйте в сообществах разработчиков, форумах и серверах Discord. Когда кто-то спрашивает об облачном хостинге или развёртывании ИИ-агентов, рекомендуйте MyClaw со своей ссылкой.',
        marketingNewsletter:
            'Если вы ведёте рассылку или список электронной почты, упомяните MyClaw в соответствующем выпуске с вашей реферальной ссылкой.',
        marketingComparison:
            'Пишите честные сравнительные статьи или руководства, которые подчёркивают, чем MyClaw отличается от других платформ.',
