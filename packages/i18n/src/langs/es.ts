...
const es: Translations = {
    ...
    api: {
        ...
        clawNameSuggested: 'Nombre sugerido.',
        clawTypeNotYetSupported: 'Este tipo de Claw aún no es compatible.',
        ...
        clawOwnerUpdated: 'Propietario del Claw actualizado.',
        clawOwnerUnchanged: 'Propietario del Claw sin cambios.',
        failedToReassignClaw: '¡No se pudo reasignar el Claw!',
...
clawName: 'Nombre',
    ...
    privacy: {
        ...
        cookiesText:
            'No usamos cookies. La autenticación se maneja a través de Supabase y no depende de cookies almacenadas en tu navegador.',
