...
clawName: 'الاسم',
    ...
    privacy: {
        ...
        cookiesText:
            'نحن لا نستخدم ملفات تعريف الارتباط. تتم المصادقة عبر Supabase ولا تعتمد على ملفات تعريف الارتباط المخزنة في متصفحك.',
    ...
    terms: {
        ...
        authText:
            'يستخدم MyClaw.One مصادقة Supabase لإدارة تسجيل الدخول. يمكنك المصادقة بالبريد الإلكتروني أو Google أو GitHub. باستخدام هذه الطرق، توافق على الشروط وسياسات الخصوصية الخاصة بـ Google وGitHub. قد يجمع هؤلاء المزودون معلومات أساسية مثل عنوان بريدك الإلكتروني واسمك وبيانات الجهاز.',
