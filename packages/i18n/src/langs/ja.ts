...
const ja: Translations = {
    ...
    api: {
        ...
        clawOwnerUpdated: 'Claw の所有者を更新しました。',
        clawOwnerUnchanged: 'Claw の所有者は変更されていません。',
        failedToReassignClaw: 'Claw の再割り当てに失敗しました!',
...
clawName: '名前',
    ...
    privacy: {
        ...
        authTitle: '2. 認証',
        authText:
            'MyClaw.Oneは、ユーザーアカウントの管理にSupabase Authenticationを使用しています。メール、Google、またはGitHubでサインインできます。これらのサインイン方法を使用することで、それぞれの利用規約とプライバシーポリシーに同意したものとみなされます。これらのプロバイダーは、メールアドレス、名前、デバイス情報などの基本データを収集する場合があります。当社はメールアドレスと表示名のみを保存します。',
        ...
        cookiesText:
            '当社はCookieを使用しません。認証はSupabaseを通じて処理され、ブラウザに保存されるCookieに依存しません。',
    ...
    terms: {
        ...
        authTitle: '3. 認証',
        authText:
            'MyClaw.Oneは、サインインの管理にSupabase Authenticationを使用しています。メール、Google、またはGitHubで認証できます。これらの方法を使用することで、GoogleおよびGitHubのそれぞれの利用規約とプライバシーポリシーに同意したものとみなされます。これらのプロバイダーは、メールアドレス、名前、デバイスデータなどの基本情報を収集する場合があります。',
