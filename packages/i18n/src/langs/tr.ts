...
const tr: Translations = {
    ...
    api: {
        ...
        clawOwnerUpdated: 'Claw sahibi güncellendi.',
        clawOwnerUnchanged: 'Claw sahibi değişmedi.',
        failedToReassignClaw: 'Claw yeniden atanamadı!',
...
clawName: 'Ad',
    ...
    privacy: {
        ...
        cookiesText:
            'Çerez kullanmıyoruz. Kimlik doğrulama Supabase aracılığıyla yönetilir ve tarayıcınızda saklanan çerezlere bağlı değildir.',
    ...
    terms: {
        ...
        authText:
            "MyClaw.One, giriş yönetimi için Supabase Authentication kullanır. E-posta, Google veya GitHub ile kimlik doğrulayabilirsiniz. Bu yöntemleri kullanarak, Google ve GitHub'ın ilgili şartlarını ve gizlilik politikalarını kabul edersiniz. Bu sağlayıcılar e-posta adresiniz, adınız ve cihaz verileriniz gibi temel bilgiler toplayabilir.",
