...
const hi: Translations = {
    ...
    footer: {
        ...
        productDescription:
            'एक क्लिक में क्लाउड या स्थानीय रूप से OpenClaw एजेंट डिप्लॉय करें — MyClaw के साथ अपने AI एजेंट तेज़ी से बनाएँ, कनेक्ट करें और स्केल करें.',
    ...
    emails: {
        otpSubject: 'आपका MyClaw साइन-इन कोड',
        otpPreview: 'आपका MyClaw साइन-इन कोड: {{code}}',
        otpHeading: 'आपका साइन-इन कोड है:',
        otpExpiry:
            'कोड 10 मिनट में समाप्त हो जाएगा. यदि यह आप नहीं थे, तो इस ईमेल को अनदेखा करें.',
        featureFooter:
            'आपको यह इसलिए प्राप्त हो रहा है क्योंकि आपके पास एक MyClaw खाता है.',
        features: {
            terminal: {
                ...
                description:
                    'हमारे बिल्ट-इन टर्मिनल से अपने सर्वर को सीधे ब्राउज़र से एक्सेस करें. कोई SSH क्लाइंट नहीं चाहिए — बस MyClaw खोलें और कमांड टाइप करना शुरू करें.',
                cta: 'टर्मिनल खोलें'
            },
            logs: {
                ...
                description:
                    'MyClaw डैशबोर्ड से रीयल टाइम में अपने सर्वर लॉग मॉनिटर करें. ब्राउज़र छोड़े बिना समस्याओं का निदान करें, डिप्लॉयमेंट ट्रैक करें और अपने एप्लिकेशन डीबग करें.',
                cta: 'लॉग देखें'
            },
            channels: {
                subject:
                ...
                description:
                    'अपने AI एजेंट को Discord, Slack, WhatsApp और अन्य से कनेक्ट करें. चैनल कॉन्फ़िगर करें और उन्हें एजेंट से जोड़ें — सब कुछ MyClaw डैशबोर्ड से.',
                cta: 'चैनल सेट करें'
            },
            fileExplorer: {
                subject:
                ...
                description:
                    'MyClaw डैशबोर्ड से सीधे अपने सर्वर पर फ़ाइलें ब्राउज़ करें, पढ़ें और संपादित करें. सिंटैक्स हाइलाइटिंग, खोज और तुरंत सहेजना — कोई SSH नहीं चाहिए.',
            ...
            agentChat: {
                ...
                description:
                    'MyClaw डैशबोर्ड से सीधे अपने AI एजेंट से चैट करें. संदेश भेजें, चित्र संलग्न करें और बातचीत का इतिहास देखें — सब एक जगह.',
            ...
            envVars: {
                ...
                description:
                    'MyClaw डैशबोर्ड से सीधे एनवायरनमेंट वेरिएबल जोड़ें, संपादित करें और हटाएँ. API कुंजियाँ, सीक्रेट और कॉन्फ़िगरेशन सेट करें — कोई टर्मिनल नहीं चाहिए.',
            ...
            sshKeys: {
                subject:
                    'क्या आप जानते हैं? MyClaw से SSH कुंजियाँ प्रबंधित करें',
                preview: 'डैशबोर्ड में SSH कुंजी जोड़ी बनाएँ और प्रबंधित करें',
                tag: 'SSH कीज़',
                heading: 'SSH कुंजियाँ, सरलीकृत',
                description:
                    'SSH कुंजी जोड़ी बनाएँ, सार्वजनिक कुंजियाँ कॉपी करें और निजी कुंजियाँ डाउनलोड करें — सब कुछ MyClaw डैशबोर्ड से. सुरक्षित पहुँच के लिए क्लॉज़ को कुंजियाँ असाइन करें.',
            ...
            multiLanguage: {
                subject: 'क्या आप जानते हैं? MyClaw आपकी भाषा बोलता है',
                preview: 'MyClaw को 14 भाषाओं में उपयोग करें',
                tag: 'मल्टी-लैंग्वेज',
                heading: 'आपकी भाषा में MyClaw',
                description:
                    'पूरे MyClaw डैशबोर्ड को 14 भाषाओं में से किसी में भी बदलें. बटनों से लेकर त्रुटि संदेशों तक — सब कुछ पूरी तरह अनुवादित.',
                cta: 'भाषा बदलें'
            },
            subdomain: {
            ...
            darkMode: {
                subject: 'क्या आप जानते हैं? MyClaw में डार्क मोड है',
                preview: 'लाइट और डार्क थीम के बीच स्विच करें',
                tag: 'डार्क मोड',
                heading: 'आँखों पर आसान',
                description:
                    'MyClaw डैशबोर्ड में लाइट और डार्क थीम के बीच टॉगल करें. आपकी पसंद सहेजी जाती है और हर बार स्वचालित रूप से लागू होती है.',
    ...
    auth: {
        signIn: 'साइन इन',
        signInDescription:
            'अपने OpenClaw इंस्टेंस प्रबंधित करने के लिए अपने MyClaw खाते में साइन इन करें.',
    ...
    account: {
        title: 'खाता',
        description:
            'अपने MyClaw खाते की सेटिंग्स और प्रोफ़ाइल जानकारी प्रबंधित करें.',
...
clawName: 'नाम',
    ...
    landing: {
        ...
        tutorialVideoThumbnail: 'MyClaw ट्यूटोरियल वीडियो थंबनेल',
        heroTitle1: 'OpenClaw डिप्लॉय करें.',
        ...
        openclawControlDescription:
            'MyClaw से सीधे मूल OpenClaw पैनल तक पहुँचें. OpenClaw जो कुछ भी प्रदान करता है उस पर पूर्ण संपादन एक्सेस.',
        clawHostControl: 'MyClaw नियंत्रण',
        ...
        faq1Question: 'MyClaw क्या है?',
        faq1Answer:
            'MyClaw एक प्लेटफ़ॉर्म है जो OpenClaw को सभी के लिए सुलभ बनाने के लिए बनाया गया है. यह गैर-तकनीकी उपयोगकर्ताओं और डेवलपर्स दोनों को बुनियादी ढाँचा प्रबंधित किए बिना OpenClaw चलाने देता है. हम सर्वर, अपटाइम, सुरक्षा और रखरखाव संभालते हैं — आप बस OpenClaw का उपयोग करें.',
        ...
        faq3Answer:
            'होस्टेड AI टूल के विपरीत, MyClaw आपको OpenClaw इंस्टॉल के साथ एक वास्तविक सर्वर देता है. आप बुनियादी ढाँचे के मालिक हैं, सब कुछ नियंत्रित करते हैं और किसी साझा प्लेटफ़ॉर्म या मॉडल से सीमित नहीं हैं.',
    ...
    changelog: {
        title: 'परिवर्तन लॉग',
        description: 'MyClaw के अपडेट, नई सुविधाएँ और सुधारों को ट्रैक करें.',
        subtitle: 'MyClaw के सभी अपडेट, नई सुविधाएँ और सुधार.',
        ...
        upcomingReleaseFeature9:
            'MyClaw पर होस्ट किए गए OpenClaw एजेंट के साथ बातचीत करने के लिए वॉइस मोड (बीटा)',
        ...
        upcomingReleaseFeature11:
            'MyClaw Go के लिए लैंडिंग पेज, MyClaw के साथ स्थानीय होस्टिंग',
        ...
        release12Feature3:
            'MyClaw पर होस्ट किए गए OpenClaw एजेंट के साथ बातचीत करने के लिए वॉइस मोड',
        release12Feature4:
            'नई शुरुआत के लिए अपने इंस्टेंस पर OpenClaw पुनः इंस्टॉल करें, प्रति दिन एक बार उपलब्ध',
        ...
        release1Description:
            'MyClaw की पहली आधिकारिक रिलीज़. एक क्लिक में अपने VPS पर OpenClaw डिप्लॉय करें.',
        ...
        release2Description: 'MyClaw के बारे में अपडेट रहने का एक नया तरीका.',
        release2Feature1:
    ...
    playground: {
        ...
        loadingTip3:
            'MyClaw एक-क्लिक OpenClaw होस्टिंग की अनुमति देने वाला पहला प्रोजेक्ट है.',
        tabChat: 'चैट',
    ...
    privacy: {
        ...
        eligibilityText:
            'हमारी सेवा किसी के लिए भी उपलब्ध है. MyClaw का उपयोग करने के लिए कोई आयु प्रतिबंध नहीं है.',
    ...
    terms: {
        ...
        description:
            'MyClaw सेवाओं का उपयोग करने के लिए नियम और शर्तें पढ़ें.',
        lastUpdated: 'अंतिम अपडेट: 14 मार्च 2026',
        acceptanceTitle: '1. शर्तों की स्वीकृति',
        acceptanceText:
            'MyClaw ("सेवा") तक पहुँचकर और इसका उपयोग करके, आप इस समझौते की शर्तों और प्रावधानों से बाध्य होने को स्वीकार और सहमत होते हैं. यदि आप इन शर्तों से सहमत नहीं हैं, तो कृपया हमारी सेवा का उपयोग न करें.',
        serviceTitle: '2. सेवा का विवरण',
        serviceText:
            'MyClaw समर्पित सर्वर पर एक-क्लिक OpenClaw डिप्लॉयमेंट प्रदान करता है. हम उपयोगकर्ताओं को पूर्ण रूट एक्सेस और समर्पित संसाधनों के साथ पूर्व-कॉन्फ़िगर OpenClaw इंस्टेंस डिप्लॉय, प्रबंधित और एक्सेस करने में सक्षम बनाते हैं.',
        authTitle: '3. प्रमाणीकरण',
        authText:
            'MyClaw साइन-इन प्रबंधित करने के लिए Google Firebase Authentication का उपयोग करता है. आप ईमेल, Google या GitHub से प्रमाणित कर सकते हैं. इन विधियों का उपयोग करके, आप Google और GitHub की संबंधित शर्तों और गोपनीयता नीतियों से सहमत होते हैं. ये प्रदाता आपके ईमेल पते, नाम और डिवाइस डेटा जैसी बुनियादी जानकारी एकत्र कर सकते हैं.',
        ...
        liabilityText:
            'कानून द्वारा अनुमत अधिकतम सीमा तक, MyClaw किसी भी अप्रत्यक्ष, आकस्मिक, विशेष, परिणामी या दंडात्मक क्षति, या प्रत्यक्ष या अप्रत्यक्ष रूप से हुए लाभ या राजस्व के किसी भी नुकसान के लिए उत्तरदायी नहीं होगा.',
    ...
    compare: {
        title: 'पूर्ण तुलना',
        description:
            'देखें कि MyClaw अन्य OpenClaw होस्टिंग प्लेटफ़ॉर्म की तुलना में कैसा है.',
        badge: 'तुलना',
        feature: 'प्लेटफ़ॉर्म',
    ...
    affiliateProgram: {
        ...
        description:
            'जानें कि MyClaw सहबद्ध कार्यक्रम कैसे काम करता है, आप कितना कमा सकते हैं और भाग लेने के नियम क्या हैं।',
        lastUpdated: 'अंतिम अपडेट: 1 अप्रैल 2026',
        overviewTitle: '1. अवलोकन',
        overviewText:
            'MyClaw सहबद्ध कार्यक्रम आपको नए उपयोगकर्ताओं को MyClaw पर रेफर करके पुरस्कार अर्जित करने देता है। जब कोई आपके रेफरल लिंक के माध्यम से MyClaw पर जाने के बाद खरीदारी करता है, तो आप उनके भुगतान पर कमीशन कमाते हैं। कार्यक्रम में शामिल होना मुफ्त है और सभी पंजीकृत MyClaw उपयोगकर्ताओं के लिए उपलब्ध है।',
        howItWorksTitle: '2. यह कैसे काम करता है',
        howItWorksText: 'सहबद्ध कार्यक्रम शुरू करना आसान है:',
        howItWorksStep1:
            'एक MyClaw खाता बनाएं। आपके लिए स्वचालित रूप से एक अद्वितीय रेफरल कोड तैयार किया जाता है।',
        howItWorksStep2:
        ...
        howItWorksStep3:
            'जब कोई आपके लिंक के माध्यम से MyClaw पर जाने के बाद खरीदारी करता है, तो इसे आपके रेफरल के रूप में ट्रैक किया जाता है।',
        howItWorksStep4:
        ...
        rulesNoMisrepresentation:
            'आप किसी भी तरह से MyClaw, इसकी सेवाओं या सहबद्ध कार्यक्रम को गलत तरीके से प्रस्तुत नहीं कर सकते।',
        rulesNoIncentivized:
        ...
        terminationText:
            'इन नियमों के किसी भी उल्लंघन का परिणाम सभी लंबित और अर्जित पुरस्कारों की तत्काल जब्ती होगी। MyClaw सहबद्ध कार्यक्रम से आपके खाते को निलंबित या स्थायी रूप से प्रतिबंधित करने का अधिकार सुरक्षित रखता है। गंभीर मामलों में, आपका MyClaw खाता भी समाप्त किया जा सकता है। उल्लंघनों के संबंध में सभी निर्णय अंतिम हैं।',
        marketingTitle: '9. कैसे प्रचार करें',
        marketingText:
            'अपना रेफरल लिंक साझा करने और अपनी कमाई बढ़ाने के कई रचनात्मक और वैध तरीके हैं:',
        marketingSocial:
            'X, LinkedIn, Reddit और Facebook जैसे सोशल मीडिया प्लेटफॉर्म पर अपना लिंक साझा करें। MyClaw के साथ अपने अनुभव के बारे में लिखें और अपना रेफरल लिंक शामिल करें।',
        marketingBlog:
            'MyClaw के बारे में ब्लॉग पोस्ट, ट्यूटोरियल या समीक्षाएं लिखें। सामग्री में स्वाभाविक रूप से अपना रेफरल लिंक शामिल करें।',
        marketingVideo:
            'YouTube या TikTok पर वीडियो सामग्री बनाएं जो दिखाए कि आप AI एजेंटों को तैनात और प्रबंधित करने के लिए MyClaw का उपयोग कैसे करते हैं।',
        marketingCommunity:
            'डेवलपर समुदायों, फोरम और Discord सर्वर में भाग लें। जब कोई क्लाउड होस्टिंग या AI एजेंट तैनाती के बारे में पूछे, तो अपने लिंक के साथ MyClaw की सिफारिश करें।',
        marketingNewsletter:
            'यदि आप न्यूज़लेटर या ईमेल सूची चलाते हैं, तो किसी प्रासंगिक अंक में अपने रेफरल लिंक के साथ MyClaw का उल्लेख करें।',
        marketingComparison:
            'ईमानदार तुलना लेख या गाइड लिखें जो यह उजागर करें कि MyClaw को अन्य प्लेटफॉर्म से क्या अलग बनाता है।',
        changesToProgramTitle: '10. कार्यक्रम में परिवर्तन',
        changesToProgramText:
            'MyClaw बिना पूर्व सूचना के किसी भी समय सहबद्ध कार्यक्रम को संशोधित, निलंबित या बंद करने का अधिकार सुरक्षित रखता है। इसमें कमीशन दरों, रेफरल विंडो, भुगतान सीमा और कार्यक्रम नियमों में परिवर्तन शामिल हैं। परिवर्तनों के बाद निरंतर भागीदारी अद्यतन शर्तों की स्वीकृति मानी जाती है।',
